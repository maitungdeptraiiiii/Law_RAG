...
ENV_KEY_ALIASES = {
    ...
    "RERANKER_PROVIDER": ["RERANKER_PROVIDER", "reranker_provider"],
    "RERANKER_MODEL": ["RERANKER_MODEL", "reranker_model"],
    "RERANKER_DEVICE": ["RERANKER_DEVICE", "reranker_device"],
    "RERANKER_USE_FP16": ["RERANKER_USE_FP16", "reranker_use_fp16"],
    "RERANKER_TEXT_LIMIT": ["RERANKER_TEXT_LIMIT", "reranker_text_limit"],
    "WARMUP_RERANKER_CACHE": ["WARMUP_RERANKER_CACHE", "warmup_reranker_cache"],
